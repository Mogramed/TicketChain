...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface ChainTicketTimelockInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'updateDelay', data: BytesLike): Result;
  ...
  export interface ChainTicketTimelock extends BaseContract {
    
    connect(runner?: ContractRunner | null): ChainTicketTimelock;
    waitForDeployment(): Promise<this>;

    interface: ChainTicketTimelockInterface;
